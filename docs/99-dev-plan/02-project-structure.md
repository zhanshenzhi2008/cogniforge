...
| 日期 | 版本 | 变更摘要 | 负责人 |
|------|------|---------|--------|
| 2026-08-18 | v1.1 | 配额落在 Go `internal/quota/`，不启用 Java billing 空目录 | orjrs |
| 2026-03-16 | v1.0 | 初始规划 | orjrs |

## [变更] 配额目录（2026-08-18）

- **变更原因**：Playground 限额要做在聊天热路径上
- **变更后**：代码进现有 Go 单体 `internal/quota/`；前端 `pages/usage.vue`
- **不采用**：~~独立 `billing/` Java 服务做第一期配额~~（2026-08-18）
